...
export const I18N = {
  ...
  local_bridge_token_help: {
    zh: `本地桥接令牌，需与配套桥接器中的令牌一致。`,
    en: `Local bridge token; it must match the token in the companion bridge.`,
    zh_TW: `本機橋接權杖，需與配套橋接器中的權杖一致。`,
    ja: `ローカルブリッジのトークン。ブリッジ側のトークンと一致させる必要があります。`,
    ko: `로컬 브리지 토큰. 브리지의 토큰과 일치해야 합니다.`,
  },
  back: {
    zh: `返回`,
    en: `Back`,
  ...
  local_bridge_required: {
    zh: `需要本地桥接`,
    en: `Local bridge required`,
    zh_TW: `需要本機橋接`,
    ja: `ローカルブリッジが必要です`,
    ko: `로컬 브리지 필요`,
  },
  local_bridge_start_help: {
    zh: `请先启动本地桥接器，并确认它仅监听 127.0.0.1。`,
    en: `Start the local bridge first and make sure it listens only on 127.0.0.1.`,
    zh_TW: `請先啟動本機橋接器，並確認它僅監聽 127.0.0.1。`,
    ja: `先にローカルブリッジを起動し、127.0.0.1 のみでリッスンしていることを確認してください。`,
    ko: `로컬 브리지를 먼저 시작하고 127.0.0.1에서만 수신하는지 확인하세요.`,
  },
  bridge_token: {
    zh: `桥接令牌`,
    en: `Bridge token`,
